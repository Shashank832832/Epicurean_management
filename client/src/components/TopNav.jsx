...
const TopNav = () => {
  ...
  return (
    <header className="h-16 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-6 sticky top-0 z-10 transition-colors duration-300">
      ...
      <div className="flex items-center w-96">
        <div className="relative w-full">
          ...
          <input 
            type="text"
            placeholder="Search events, inventory, bills..."
      ...
      <div className="flex items-center gap-4 relative">
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-slate-200 dark:border-slate-700 ml-2">
          ...
          <button 
            onClick={logout}
            className="p-2 ml-2 text-slate-500 hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-500/10 dark:hover:text-red-400 rounded-full transition-colors"
            title="Logout"
          >
            <LogOut size={18} />
          </button>
